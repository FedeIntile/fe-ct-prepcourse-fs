...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   return objetoMisterioso.numeroMisterioso * 5;  // esto es igual:return objetoMisterioso["numeroMisterioso"] * 5
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   if (objetoUsuario["email"] !== null && objetoUsuario.email !== undefined){ // con esto alcanzaba (objetoUsuario.email)
      return true;
   } else return false; 
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar True. Caso contrario, False.
   // Tu código:
   if(objeto.hasOwnProperty(propiedad)){ // esta tb funciona:(objeto.[propiedad]) 
      return true;
   } else return false; 
}
